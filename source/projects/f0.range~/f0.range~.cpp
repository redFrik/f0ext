...
int C74_EXPORT main(void) {
    t_class *c= class_new("f0.range~", (method)f0ext_new, (method)dsp_free, sizeof(t_f0ext), NULL, A_GIMME, 0);
...
void f0ext_dsp(t_f0ext *x, t_signal **sp, short *count) {
    dsp_add(f0ext_perform, 6, sp[0]->s_vec, sp[1]->s_vec, sp[2]->s_vec, sp[3]->s_vec, sp[0]->s_n, x);
}
void f0ext_dsp64(t_f0ext *x, t_object *dsp64, short *count, double samplerate, long maxvectorsize, long flags) {
