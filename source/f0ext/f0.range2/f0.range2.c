...
int C74_EXPORT main(void) {
    t_class *c= class_new("f0.range2", (method)f0ext_new, (method)NULL, (long)sizeof(t_f0ext), 0L, A_GIMME, 0);
    ...
    f0ext_class= c;
    post("f0.range2 v2.01-64/32bit; distributed under GNU GPL license");
    return 0;
}
void *f0ext_new(t_symbol *s, long argc, t_atom *argv) {
